...
for ep in mp_intake_resend mp_import_upload mp_import_report mp_exception_add mp_exception_revoke mp_product_archive mp_product_restore mp_product_edit mp_automator_export_csv mp_automator_checklist_toggle mp_automator_checklist_config mp_automator_response_config mp_automator_pool_config; do
	A=$(code "" "$AP" "$ep")
