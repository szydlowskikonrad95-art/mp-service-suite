<?php
/**
 * Numer sprawy SRV/RRRR/NNNN — licznik ATOMOWY per rok (format wprost ze specyfikacji).
 *
 ...
 * SRV/RRRR/NNNN, NNNN = 4 cyfry z zerami wiodacymi (0001). Po przekroczeniu 9999
 * spraw w roku numer rosnie naturalnie do 5 cyfr — sprintf nie ucina wartosci,
 * wiec licznik nigdy sie nie zapetli ani nie zdubluje.
...
final class SrvCounter {
	...
	public static function next( int $year ): string {
		...
		// SELECT LAST_INSERT_ID() (moglby trafic na replike). Jedno zapytanie mniej.
